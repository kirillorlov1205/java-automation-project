...
public class LoginPage extends AbstractPage{
	...
	private static final By LOGIN_BUTTON = By.cssSelector(".button2_theme_mail-white");
	...
	public static Input getUserIdField() {
		return new Input(UiDriver.getDriver(), USER_ID_FIELD_LOCATOR);
	}

	public static Input getUserPasswordField() {
